...
with col1:
    ...
    st.markdown(
        f"""
        <a href="{FORECASTING_PAGE_PATH}" target="_self" style="{link_style}">
            <div style="{forecasting_div_style}">
                <h2 style="color: #4CAF50; margin-bottom: 15px;">🔮 Load Forecasting</h2>
                <p style="color: #333; margin-bottom: 10px;">Access the forecasting module to predict future energy consumption using the GRU model.</p>
